    ...
    public async Task<PagedList<MemberDto>> GetUserLikes(LikesParams likesParams)
    {
        ...
        switch (likesParams.Predicate)
        {
            ...
            default:
                ...
                query = likes.Where(x => x.TargetUserId == likesParams.UserId && likesIds.Contains(x.SourceUserId)).Select(x => x.SourceUser).ProjectTo<MemberDto>(mapper.ConfigurationProvider);
                break;
        }
